...
<div id="hide_in_print" style=" float: right;margin-right: 10px">
    <form action="<?php echo base_url();?>welcome/filtered" method="POST">
    <label style="float: left">Filter % &nbsp;</label>
    <input placeholder="From" style="width: 50px;height: 23px;border-radius: 5px;color: #000" type="text" name="start" /> to
    <input style="width: 50px;height: 23px;border-radius: 5px;color: #000" type="text" name="end" />
    <input style="border-radius: 5px;" type="submit" value="go"/>
</div>
...
<div id="smile" style="margin-top: -1%">
    ...
    <div id="<?php echo $row->id;?>" class="panel panel-primary <?php echo $row->id;?>">
            ...
            <div class="panel-body">
                <div class="form-group">
                      <table class="table table-bordered table-condensed table-centered">
                        ...
                        <thead id="hide_this" title="<?php echo $row->h_d_rate;?> %">
                        	<td>
						...
						$this->db->order_by('h_d_rate','ASC');
						$added = $this->db->get('added_rooms');
						foreach($added->result() as $added_rooms):?>
                        <thead id="hide_this" title="<?php echo$added_rooms->h_d_rate;?> %">
...
<script type='text/javascript'>
	//alert('');
	$('html, body').animate({
		scrollTop: $('.<?php echo $_GET['success'];?>').offset().top
	},500);
</script>